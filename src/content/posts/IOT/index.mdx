...
Project description This robot is controlled using DTMF (Dual Tone Multiple Frequency). With the help of a mobile phone, you can control the motion of the robot. The heart if the robot is an Arduino Mega board.
