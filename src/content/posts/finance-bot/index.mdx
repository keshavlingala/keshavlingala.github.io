---
title: "finance-bot: Personal Finance That Files Itself"
slug: finance-bot
featuredImage: images/feature.png
tags: ['Finance automation','Personal finance','Firefly III','Budgeting','Net worth tracking','Bill tracking','SimpleFIN','Open banking','Telegram bot','Chat interface','Python','Stdlib only','No dependencies','SQLite','Job scheduler','Automated categorisation','Self-hosted','Home lab','Privacy','Keshav Lingala','Keshav Reddy','Keshav Reddy Lingala','Lingala Keshav Reddy','Keshav']
description: "An automation layer over my own Firefly III ledger, running on hardware in my apartment. Transactions import and categorise themselves overnight, budgets and bills track themselves, and I ask it questions in plain English from a chat window on my phone."
date: '2026-08-21'
...
<Diagram variant="grid" title="What it does for me">
...
<Diagram variant="grid" title="From a chat window">
...
<Diagram variant="grid" title="The unglamorous half">
