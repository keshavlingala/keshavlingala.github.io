export const siteMetadata = {
  ...
  keywords:
    "keshav lingala, keshav lingala portfolio, keshav lingala software engineer, senior software engineer dayton, keshav reddy lingala, lingala keshav reddy, full stack engineer, java angular react spring boot, keshav lingala profile",
  ...
  location: { city: "Dayton", region: "OH", country: "US" },
};
