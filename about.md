...
- [finance-bot: Personal Finance That Files Itself](https://keshav.codes/finance-bot/) — An automation layer over my own Firefly III ledger, running on hardware in my apartment. Transactions import and categorise themselves overnight, budgets and bills track themselves, and I ask it questions in plain English from a chat window on my phone.
  - Markdown: https://keshav.codes/finance-bot.md
- [Okepage: Print Many Photos on One Page, In Your Browser](https://keshav.codes/okepage/) — A single browser page that lays a pile of photos onto A4 sheets ready to print and cut — for people who just want prints, without the hassle of design tools, word processors or a trip to the photo shop. No accounts, no upload, and it works offline.
  - Markdown: https://keshav.codes/okepage.md
- [beast: A Private AI Cloud I Deploy To From My Phone](https://keshav.codes/homelab/) — A machine in my apartment that runs local AI models, image and video generation, my personal finance system and my file storage. I deploy to it from my phone over breakfast, drive coding agents on it from anywhere, and it costs nothing per month because I own it.
  - Markdown: https://keshav.codes/homelab.md
