# Aakarshan Artboard: A Social Media Hub for Artists
...
- **Published:** June 2019
- **Project page:** https://keshav.codes/aakarshan/ (screenshots and diagrams are on that page)
- **Tech:** HTML, CSS, Bootstrap, Angular, Typescript, Firebase, PWA
- **Live demo:** https://aakarshan.web.app/
- **Source:** https://github.com/keshavlingala/AakarshanClub
- **Topics:** Artclub, Aakarshan, Aakarshan Artclub, KMIT, Aakarshan KMIT, KMIT Aakarshan, Keshav Lingala, Keshav Reddy, Keshav Reddy Lingala, Lingala Keshav Reddy, Keshav
...
*Figure: Upload Images*

### 3. Pick a profile card while registering

*Figure: Profile Card / Registration*

### 4. Like, comment, and share

*Figure: Like, Comment, and Share*

### 5. Get notified whenever there is a new post

*Figure: Post Notifications*
